...
☀️ День: «Сегодня от Стагирита» с готовой рабочей пятёркой, при наличии «Вчера от Стагирита», встречи сегодня, личные задачи, итоги. После того как Неония один раз получила/обновила общий пул людей, ежедневно возвращаться к Неонии не нужно: Стагирит сам готовит пятёрку. Встречи сегодня → День; полный календарь/новая встреча → Календарь.
📅 Календарь: «Календарь» / «Назначить встречу». Не объявляй встречу назначенной, пока запись реально не создана.

🤖 Агенты → «🧭 Стагирит» → Стагирит / Неония / Неона / Неола. Стагирит 1.0 принимает поручение обычными словами, без OpenAI проверяет календарь и свободные окна; в контенте он координирует Мастера контента и Художника. К готовому материалу можно загрузить картинку или MP4-ролик; к ролику анонс пишет Мастер контента. После утверждения ролик с анонсом можно отправить всей нижестоящей структуре внутри Агентства W и отдельно — в выбранные Telegram-площадки.
...
Инструменты: «👥 Партнёры», «💬 Сообщения», «📚 Инструкции», «🔔 Объявления», «📣 Мои площадки».
...
Мои площадки: Команда → Инструменты → «📣 Мои площадки» — подключённые Telegram-группы и каналы. Готовый ролик идёт из контентного поручения Стагирита: загрузить MP4 → Мастер контента пишет анонс → владелец утверждает → можно отдельно отправить всей структуре внутри Агентства и/или выбрать внешние площадки и отправить одним махом.
